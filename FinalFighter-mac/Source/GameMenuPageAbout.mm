...
- (void)updatePage1
{
    ...
    label.string = @"\
Move tank with [WASD] (or [ZQSD]) \n \
Move turret with mouse or touchpad \n \
Switch weapons with [1-5] or [Q] and [A] \n \
or mouse wheel or right mouse button \n \
\n \
Play next music track with [M] \n \
\n \
Toggle fullscreen/window mode with CMD+F \n \
";
}
